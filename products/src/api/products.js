...
const { PublishMessae } = require('../utils');
...
module.exports = (app,channel) => {
    ...
    app.put('/wishlist',UserAuth, async (req,res,next) => {
        ...
        try {
            ...
            PublishMessae(channel, CUSTOMER_BINDING_KEY, JSON.stringify(data));
    ...
    app.put('/cart',UserAuth, async (req,res,next) => {
        ...
        try {     
            ...
            PublishMessae(channel, SHOPPING_BINDING_KEY, JSON.stringify(data));
